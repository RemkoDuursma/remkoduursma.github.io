...
categories: ["R"]
tags: ["spatial", "maps"]
description: "Four examples on plotting colored geographic maps in R. This simple example is for Australian population by state, but applies to more complicated datasets also."
---
...
```{r echo=FALSE}
oz2 <- read.csv("c:/repos/remkoweb/static/files/ozdata.csv")
```
